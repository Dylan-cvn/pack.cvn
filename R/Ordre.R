...
#'
#' `Ordre()` trie un vecteur comme `base::sort()`.
#' Tu peux faire `Ordre(x)[k]` pour obtenir la k-ième statistique d'ordre.
#'
#' @param x Vecteur à trier.
#' @param decreasing Logique : tri décroissant ? (FALSE par défaut)
#' @param na.last NA/TRUE/FALSE : où placer les valeurs manquantes.
